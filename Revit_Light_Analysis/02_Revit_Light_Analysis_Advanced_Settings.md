# ⚙️ 조명 분석 고급 설정 (Light Analysis Settings) 가이드

이 문서는 Revit 조명 분석 시 **`_InsightLighting Model View`** 3D 뷰의 속성을 제어하는 고급 설정창(좌측 하단 톱니바퀴)에 대한 상세 설명입니다.

이 설정들은 분석의 **정확도**와 **속도**, 그리고 **가시성**을 결정하는 중요한 옵션들입니다. 각 항목을 클릭하여 상세 내용과 활용법을 확인하세요.
...
* **활용:** 벽을 옮겼는데 예전 조도 결과가 그대로 떠 있으면 혼동이 오겠죠? 이를 방지합니다.
</details>
...
* **활용:** 건물 내부 깊숙한 곳의 결과를 단면 쳐서 확인할 때 유용합니다.
</details>
