# 02. 📊 Revit Energy Analysis Data Inventory Summary

이 문서는 `01_Revit_Energy_Raw_Data.md`의 방대한 항목을 **빠르게 파악하기 위한 요약본**입니다.
...
원본 데이터 전체는 `01_Revit_Energy_Raw_Data.md`에서 확인하세요.
